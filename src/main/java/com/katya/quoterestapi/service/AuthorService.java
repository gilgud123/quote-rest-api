...
public class AuthorService {
  ...
  public Page<AuthorDTO> getAllAuthors(Pageable pageable) {
    ...
    return authorRepository.findAll(pageable).map(authorMapper::toDtoWithoutQuotes);
  }
