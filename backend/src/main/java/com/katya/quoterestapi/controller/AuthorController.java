...
/**
 * REST Controller for Author-related endpoints. Provides CRUD operations with validation,
...
public class AuthorController {
  ...
  public ResponseEntity<Page<AuthorDTO>> getAllAuthors(
    ...
    log.info(
        "GET /api/v1/authors - page: {}, size: {}, sortBy: {}, direction: {}",
        page,
        size,
        sortBy,
        direction);
  ...
  @Operation(
      ...
      description = "Retrieve a specific author with all their quotes")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
  ...
  public ResponseEntity<Page<AuthorDTO>> filterAuthors(
      @Parameter(description = "Birth year") @RequestParam(required = false) Integer birthYear,
      @Parameter(description = "Minimum birth year") @RequestParam(required = false)
          Integer minYear,
      @Parameter(description = "Maximum birth year") @RequestParam(required = false)
          Integer maxYear,
      @Parameter(description = "Page number (0-based)") @RequestParam(defaultValue = "0") @Min(0)
          int page,
      @Parameter(description = "Page size") @RequestParam(defaultValue = "10") @Min(1) @Max(100)
          int size,
      @Parameter(description = "Sort field") @RequestParam(defaultValue = "birthYear")
          String sortBy,
      @Parameter(description = "Sort direction") @RequestParam(defaultValue = "ASC")
          Sort.Direction direction) {
    log.info(
        "GET /api/v1/authors/filter - birthYear: {}, minYear: {}, maxYear: {}",
        birthYear,
        minYear,
        maxYear);
  ...
  @Operation(
      ...
      description = "Get statistics for a specific author")
  @ApiResponses(
      value = {
  ...
  public ResponseEntity<AuthorDTO> createAuthor(
      @Parameter(description = "Author data", required = true) @Valid @RequestBody
          AuthorDTO authorDTO) {
  ...
  public ResponseEntity<AuthorDTO> patchAuthor(
      @Parameter(description = "Author ID", required = true) @PathVariable Long id,
      @Parameter(description = "Author data (partial)", required = true) @RequestBody
          AuthorDTO authorDTO) {
