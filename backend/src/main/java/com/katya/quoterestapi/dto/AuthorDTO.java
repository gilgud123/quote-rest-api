...
/** DTO for Author entity using Java Record. Used for transferring author data between layers. */
@Schema(description = "Author data transfer object")
@JsonInclude(JsonInclude.Include.NON_NULL)
public record AuthorDTO(
    @Schema(description = "Unique identifier of the author", example = "1") Long id,
    ...
    @Min(value = -500, message = "Death year must be at least -500")
        ...
        Integer deathYear,
    @Schema(description = "List of quotes by this author") List<QuoteDTO> quotes,
    @Schema(description = "Timestamp when the author was created") LocalDateTime createdAt,
    @Schema(description = "Timestamp when the author was last updated") LocalDateTime updatedAt) {
