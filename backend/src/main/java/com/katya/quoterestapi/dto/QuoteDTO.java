...
/** DTO for Quote entity using Java Record. Used for transferring quote data between layers. */
@Schema(description = "Quote data transfer object")
@JsonInclude(JsonInclude.Include.NON_NULL)
public record QuoteDTO(
    @Schema(description = "Unique identifier of the quote", example = "1") Long id,
    ...
    @Size(max = 500, message = "Context must not exceed 500 characters")
        @Schema(
            description = "Context or occasion when the quote was said",
            example = "At his trial")
        String context,
    ...
    @NotNull(message = "Author ID is required")
        ...
        Long authorId,
    @Schema(description = "Name of the author (for display purposes)") String authorName,
    @Schema(description = "Timestamp when the quote was created") LocalDateTime createdAt,
    @Schema(description = "Timestamp when the quote was last updated") LocalDateTime updatedAt) {
  ...
  public QuoteDTO(
      Long id, String text, String context, String category, Long authorId, String authorName) {
