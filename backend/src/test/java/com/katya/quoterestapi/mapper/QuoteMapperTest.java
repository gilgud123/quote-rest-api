...
class QuoteMapperTest {
  ...
  void setUp() {
    ...
    testAuthor = Author.builder().id(1L).name("Socrates").build();
  ...
  void shouldUpdateEntityFromDto() {
    ...
    QuoteDTO updateDTO =
        new QuoteDTO(
            null, "Updated quote text", "Updated context", "Wisdom", null, null, null, null);
  ...
  void shouldMapListToDtos() {
    // Given
    Quote quote2 =
        Quote.builder().id(2L).text("I know that I know nothing").author(testAuthor).build();
